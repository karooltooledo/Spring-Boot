...
public class ProdutosController {
	...
	@PostMapping
 	public ResponseEntity<Produtos> post(@RequestBody Produtos nome) {
		return ResponseEntity.status(HttpStatus.CREATED).body(produtosRepository.save(nome));
	}
	//Alterar Postagem
	@PutMapping	
 	public ResponseEntity<Produtos> put(@RequestBody Produtos nome) {
		return ResponseEntity.status(HttpStatus.OK).body(produtosRepository.save(nome));
	}
	//Deletar Postagem
	@DeleteMapping("/{id}")
